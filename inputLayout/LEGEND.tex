...
\begin{tikzpicture}
    ...
    \sextupole[0]{5}{ }{0}
    \node[align=left,anchor=west] at (5.2,0) {Sextupole};

    \BTV[0.5]{7.2}{};
    \node[align=left,anchor=west] at (7.5,0.5) {BTV screen};
    
    \cBPM[-0.05]{7.2}{}{0.15};
    \node[align=left,anchor=west] at (7.5,-0.05) {Cavity BPM};
    
    \iBPM[-0.5]{7.2}{};
    \node[align=left,anchor=west] at (7.5,-0.5) {Inductive BPM};
    ...
    \prescatt[0]{12.85}{}
    \node[align=left,anchor=west] at (12,-0.5) {Pre-scatterer};

    \scatt[0]{11.4}{}
    \node[align=left,anchor=west] at (10.4,-0.5) {Scatterer};
    \node[align=left,anchor=west] at (10.4,1.3) {\large
    {Scattering System}};

    \node at (15.4,0.75) {Electron beam};
    \draw[ultra thick, -latex] (16.4,0.25) -- (14.4,0.25);

    \node at (15.4,-0.25) {LASER beam};
    \draw[thick, dashed, -latex] (14.4,-0.75) -- (16.4,-0.75);
