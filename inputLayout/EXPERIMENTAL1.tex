...
%% K. Sjobak, 2018--2020, D. Gamba 2020
    ...
    \node at (4.3,-2.25+\BotLegyOFF) {\textbf{Plasma lens}};
    ...
    \filldraw[ultra thick, orange] (10.1,-0.15) rectangle (9.7,0.15);
    \if\getvalue{elemnames}1
        \node[rotate=-90,anchor=west] at (9.9,-0.7)
            {\belemsiz ACS 640};
    \fi

    \filldraw[ultra thick, orange] (9.6,-0.15) rectangle (9.2,0.15);
    \filldraw[purple] (9.53,-0.4) rectangle (9.48,0.4);
    \if\getvalue{elemnames}1
...
%    \node[anchor=south] at (0.9,0.3) {\belemsiz BTV 910};
    ...
    \if\getvalue{auxElems}1
        \filldraw[orange!65] (11.5,0.7) -- (11.5+0.5,1.7) -- (11.5-0.5,1.7) -- cycle;
        \draw[ultra thick, orange!65,] (11.5,1.45) -- (9.6,1.45);
        \draw[ultra thick, orange!65, dashed, -latex] (9.6,1.45) -- (9.6,0.2);
        \draw[ultra thick, orange!65, dashed, -latex] (9.6,1.45) -- (9.6,0.8) -- (10.1,0.8) -- (10.1,0.2);
        \if\getvalue{elemnames}1
            \node[align=center,anchor=north] at (11.5,1.7) {\belemsiz MKX\\ \belemsiz 1};
        \fi
    \fi
