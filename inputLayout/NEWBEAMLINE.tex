...
\pgfmathsetmacro{\BreakY}{\SrcY + (\SrcX-\BreakX)*tan(\SrcAngle)}  % <-- missing
    ...
    %In Vacuum test area
    \filldraw[green] (4.75,-0.5) rectangle (3.5,0.5);
    %\node at ({3},-2.5+\BotLegyOFF) {\textbf{In Vacuum test area}};


    %IN-AIR table
    \filldraw[green] (-0.6,-0.5) rectangle (0.2,0.5);
    %\node[align=left,anchor=west] at (-0.7,-1.4) {\textbf{In-Air}\\ \textbf{test area II}};
   ...
   (\BreakX,\BreakY);
    ...
    \correctorMagnet{\CORx}{DJ 175};
    \end{scope}
    \if\getvalue{elemnames_newbeamline}1
        \node[rotate=-90] at (9.8, 1.0) {\belemsiz DJ 175};
    \fi
    ...
    \end{scope}
    \if\getvalue{elemnames_newbeamline}1
        \node[rotate=-90] at (12.6, -0.0) {\belemsiz QFG 130};
    \fi

    \pgfmathsetmacro{\CORx}{12.9}
    \pgfmathsetmacro{\CORy}{\SrcY + (\SrcX-\CORx)*tan(\SrcAngle)}
    \begin{scope}[shift={(0,\CORy)}, rotate around={\BeamDir:(\CORx,0)}]
    \correctorMagnet{\CORx}{DJ 145};
    \end{scope}
    \if\getvalue{elemnames_newbeamline}1
       \node[rotate=-90] at (13.1, -0.20) {\belemsiz DJ 145};
    \fi
   ...
   % --- BPM on the diagonal at x = 12.00 ---
    ...
    \end{scope}
    \if\getvalue{elemnames_newbeamline}1
        \node[rotate=-90] at (15.40, -1.3) {\belemsiz BPM 105};
    \fi
    ...
    \fi
    \correctorMagnet{7.5}{DHJ 310};
    \if\getvalue{elemnames_newbeamline}1
        \node[rotate=-90] at (7.5,1.6) {\belemsiz DHJ 310};
    \fi
    ...
    \fi
    \correctorMagnet{5.6}{DHJ 335};
    \if\getvalue{distances}1
        \node at (5.2,1.15) {\belemsiz 31.66~m};
    \fi
    \if\getvalue{elemnames_newbeamline}1
        \node[rotate=-90] at (5.6,1.6) {\belemsiz DHJ 335};
    \fi
    ...
    \correctorMagnet{2.6}{DHJ 505};
    \if\getvalue{distances}1
        \node at (2.95,0.9) {\belemsiz 33.38~m};
    \fi
    \if\getvalue{elemnames_newbeamline}1
        \node[rotate=-90] at (2.6,1.6) {\belemsiz DHJ 505};
    \fi

    \iBPM{2.2}{BPM 510};
    \if\getvalue{elemnames_newbeamline}1
        \node[rotate=-90] at (2.2,1.6) {\belemsiz BPM 510};
    \fi
        \BTV{1.65}{BTV 520};
    \if\getvalue{distances}1
    ...
    \fi
    \if\getvalue{elemnames_newbeamline}1
        \node[rotate=-90] at (1.65,1.6) {\belemsiz BTV 520};
    \fi
    

    \lensD{1.2}{QFG 525};
        \if\getvalue{elemnames_newbeamline}1
        \node[rotate=-90] at (1.2,1.6) {\belemsiz QFG 525};
    \fi
    \lensF{0.8}{QDG 535};
        \if\getvalue{elemnames_newbeamline}1
        \node[rotate=-90] at (0.8,1.6) {\belemsiz QDG 535};
    \fi
    \lensD{0.4}{QFG 525};
        \if\getvalue{elemnames_newbeamline}1
        \node[rotate=-90] at (0.4,1.6) {\belemsiz QFG 525};
    \fi
    ...
    \fi
    %ICT 
    %\filldraw[purple] (0.1,-0.3) rectangle (0.2,0.3);
    %\if\getvalue{elemnames}1
